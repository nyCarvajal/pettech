...
CREATE TABLE IF NOT EXISTS user_role (
  ...
  KEY user_role_tenant_user_role_idx (tenant_id, user_id, role_id),
  CONSTRAINT user_role_tenant_id_fk FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE,
  CONSTRAINT user_role_created_by_fk FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS role_permission (
  ...
  updated_at TIMESTAMP NULL,
  deleted_at TIMESTAMP NULL,
  UNIQUE KEY role_permission_unique (permission_id, role_id),
  KEY role_permission_tenant_role_permission_idx (tenant_id, role_id, permission_id),
  CONSTRAINT role_permission_tenant_id_fk FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE,
  CONSTRAINT role_permission_created_by_fk FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL,
  CONSTRAINT role_permission_permission_id_fk FOREIGN KEY (permission_id) REFERENCES permissions(id) ON DELETE CASCADE,
  CONSTRAINT role_permission_role_id_fk FOREIGN KEY (role_id) REFERENCES roles(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
