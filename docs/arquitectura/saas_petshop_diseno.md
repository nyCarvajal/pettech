...
## Módulos
1. **RBAC**: `roles`, `permissions`, `role_user`, `permission_role`.
...
- `role_user`: tenant_id, created_by, role_id, model_id, model_type, timestamps, deleted_at.
- `permission_role`: tenant_id, created_by, permission_id, role_id, timestamps, deleted_at.
